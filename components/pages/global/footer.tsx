...
const footerLinks = {
  company: {
    ...
    links: [
      ...
      { label: "Research & Development", href: "/about-us/research-and-development" },
    ],
  },
  resources: {
    title: "Products",
    links: [
      {
        label: "CBOT-P", href: "/products/cbot-p"
      },
      {
        label: "COT", href: "/products/cot"
      },
      {
        label: "DDT", href: "/products/ddt"
      },
      { label: "EMRAST", href: "/products/emrast" },
    ],
  },
  quickLinks: {
    title: "Quick Links",
